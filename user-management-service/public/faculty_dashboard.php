...
<html lang="en">
  <head>
    ...
    <link rel="shortcut icon" href="/assets/ITU-Lahore-Punjab.jpg" type="image/x-icon" />
    <!-- Tailwind CSS CDN -->
    ...
    >
      ...
      <nav class="flex-1 overflow-y-auto mt-4">
        <ul>
          ...
          <li class="mb-2">
            <a href="/academics/faculty_schedule.php" class="flex items-center px-4 py-2 hover:bg-gray-200 rounded">
        ...
        <li class="mb-2">
            <a href="/academics/faculty_messages.php" class="flex items-center px-4 py-2 hover:bg-gray-200 rounded relative">
