    ...
    <aside id="sidebar" class="w-64 bg-white shadow-lg md:block hidden flex flex-col">
        ...
        <nav class="px-4 flex-1">
            <ul>
                ...
                <li class="mb-2">
                    <a href="/courses/courses.php" class="flex items-center p-3 rounded sidebar-link">
                        <i class="fas fa-book mr-3"></i>
                        <span class="ml-1">Courses</span>
                    </a>
                </li>
                <li class="mb-2">
                    <a href="/academics/schedule.php" class="flex items-center p-3 rounded sidebar-link">
                        <i class="fas fa-calendar-alt mr-3"></i>
                        <span class="ml-1">Schedule</span>
                    </a>
                </li>
                <li class="mb-2">
    <a href="/academics/admin_messages.php" class="flex items-center p-3 rounded sidebar-link <?= basename($_SERVER['PHP_SELF']) === 'admin_messages.php' ? 'active' : '' ?>">
