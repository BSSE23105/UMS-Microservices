...
require __DIR__ . '/../src/db.php'; // Use existing config file
    ...
    >
      ...
      <nav class="flex-1 overflow-y-auto">
        <ul class="mt-4">
          ...
          <li class="mb-2">
            <a
              href="/courses/enroll_courses.php"
              class="flex items-center px-4 py-2 hover:bg-gray-200 rounded"
              ><svg
                class="h-5 w-5 itu-primary"
                fill="none"
          ...
          <li class="mb-2">
    <a href="/academics/student_messages.php" class="flex items-center px-4 py-2 hover:bg-gray-200 rounded">
