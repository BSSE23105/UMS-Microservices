...
");
$stmt->bind_param("iii", $message_id, $student_id, $student_id);
$stmt->execute();
...
if ($result->num_rows > 0) {
    ...
    // Mark as read if student is receiver
    if ($message['receiver_id'] == $student_id && $message['receiver_type'] == 'student' && !$message['is_read']) {
    ...
    <div class="flex-1 flex flex-col overflow-y-auto">
        ...
        <div class="p-6 flex-1">
            <div class="bg-white rounded-lg shadow max-w-4xl mx-auto">
                <div class="flex justify-between items-center px-6 py-4 border-b">
                    ...
                    <div>
                        <a href="student_messages.php?tab=<?= $tab ?>" class="bg-gray-200 text-gray-700 px-4 py-2 rounded-lg hover:bg-gray-300 transition flex items-center">
                ...
                <div class="p-6">
                    <?php if ($message): ?>
                        <div class="message-header pb-6 mb-6">
                            <div class="flex justify-between items-start">
                                ...
                                <div class="text-right">
                                    ...
                                    <?php if ($message['is_read'] && $message['receiver_type'] === 'student'): ?>
                        ...
                        <div class="flex justify-between items-center border-t pt-4">
                            ...
                            <div>
                                <form method="POST" action="student_messages.php" class="inline">
        ...
        onclick="return confirm('Are you sure you want to delete this message?');">
                                ...
                                <?php if ($message['sender_id'] != $student_id): ?>
                                    <a href="compose_message_student.php?reply=<?= $message['id'] ?>" 
                    ...
                    <?php else: ?>
                        <div class="text-center py-12">
                            ...
                            <a href="student_messages.php" class="inline-block mt-6 bg-itu-primary text-white px-6 py-2 rounded-lg">
                                Back to Messages
                            </a>
                        </div>
                    <?php endif; ?>
