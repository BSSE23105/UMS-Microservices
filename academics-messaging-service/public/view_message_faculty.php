    ...
    <div class="sidebar w-64 bg-itu-primary text-white flex flex-col">
        ...
        <div class="flex-1 py-4">
            <nav>
                ...
                <a href="/courses/faculty_courses.php" class="block py-3 px-6 hover:bg-itu-secondary">
                    <i class="fas fa-book mr-3"></i>My Courses
                </a>
                <a href="/courses/faculty_schedule.php" class="block py-3 px-6 hover:bg-itu-secondary">
                    <i class="fas fa-calendar-alt mr-3"></i>Schedule
                </a>
                <a href="/courses/faculty_students.php" class="block py-3 px-6 hover:bg-itu-secondary">
